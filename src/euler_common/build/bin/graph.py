...
datasets = [
    "data/hislennoereshG.csv",
    "data/hislennoereshGK.csv", 
    "data/hislennoereshGKR.csv",
    "data/hislennoereshENO.csv",
    "data/hislennoereshWENO.csv",
    "data/hislennoereshFL.csv",
    "data/hislennoereshCustom.csv",
    "data/hislennoereshKabare.csv"  # Добавлен Custom файл
]
...
colors = ['#086522', '#FF4500', '#00FFFF', '#FF00FF', '#0000FF', '#00FF00', '#FFA500', '#800080']
labels = [
    "Exact solution", 
    "Godunov scheme", 
    "Godunov-Kolgan scheme", 
    "Godunov-Kolgan-Rodionov scheme",
    "ENO scheme",
    "WENO scheme",
    "FL scheme",
    "Custom scheme",
    "Kabare scheme"  # Добавлена метка для Custom
]

markers = ['', 'o', 'o', 'o', 'o', 'o', 'o', 'o']
markersizes = [0, 2, 2, 2, 2, 2, 2, 2]
...
for i in range(len(datasets)):
    if xs_starts[i] and Ps_starts[i]:
        ...
        axs[0,0].plot(xs_starts[i], Ps_starts[i], '-'+marker, color=colors[i+1], markersize=markersizes[i+1], label=labels[i+1], linewidth=1)
